...
<div id="about">
			<h2 in:fly={{ duration: 400, x: -200, delay: 200 }}>About Me</h2>
	<div class="wrapper">
		<div class="text">
			<p in:fly={{ duration: 400, x: -200, delay: 400 }}>
			...
			<p in:fly={{ duration: 400, x: -200, delay: 600 }}>
			...
			<p in:fly={{ duration: 400, x: -200, delay: 800 }}>
