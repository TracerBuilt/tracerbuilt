...
<header
	class="z-20 mt-2 mx-auto mb-6 flex h-[3rem] w-full items-baseline justify-end px-1 px-2 leading-normal"
>
	<nav
		class=" flex flex-wrap items-baseline justify-end gap-2 text-sm sm:gap-4 sm:text-base"
	>
